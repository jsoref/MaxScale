...
/**
 * @brief readenv_int Read integer value of environmental variable, if empty - set default
 * @param name Name of the variable
...
/**
 * @brief readenv_int Read boolean value of environmental variable, if empty - set default
